...
const translations = {
    ar: {
        ...
        "a2.h1": "الذكاء الاصطناعي: المظلة الكبيرة",
        "a2.p1": "قبل لا نفرّق بينهم، لازم نفهم إن \"الذكاء الاصطناعي\" (AI) هو المصطلح الأشمل، ويقصد به أي نظام يحاكي القدرات البشرية زي التفكير، التعلم، واتخاذ القرار. تحت هذي المظلة الكبيرة يندرج \"التعلم الآلي\"، وتحت التعلم الآلي بدوره يندرج \"التعلم العميق\". يعني كل تعلم عميق هو تعلم آلي، لكن مو كل تعلم آلي هو تعلم عميق.",
        "a2.h2": "التعلم الآلي: النظام يتعلم من الأمثلة",
        "a2.p2a": "التعلم الآلي هو أسلوب يخلي الحاسوب يتعلم من البيانات بدل ما نكتب له تعليمات صريحة لكل حالة. بدل ما نبرمج قواعد ثابتة، نعطي النظام كمية كبيرة من الأمثلة (زي آلاف المعاملات المالية السابقة)، وهو يتعلم الأنماط ويستخدمها للتنبؤ بحالات جديدة. مثال عملي: نموذج يتنبأ بسعر عقار بناءً على المساحة والموقع وعدد الغرف، بالاعتماد على بيانات آلاف العقارات السابقة.",
        "a2.p2b": "التعلم الآلي فعّال جداً مع البيانات المنظمة (زي جداول الأرقام والفئات)، ويحتاج عادة بيانات أقل نسبياً مقارنة بالتعلم العميق، وأسرع في التدريب والتشغيل.",
        "a2.h3": "التعلم العميق: شبكات تحاكي الدماغ البشري",
        "a2.p3a": "التعلم العميق هو فرع متقدم من التعلم الآلي، يعتمد على \"الشبكات العصبية الاصطناعية\" المكوّنة من طبقات متعددة (ومن هنا جاءت كلمة \"عميق\" - أي طبقات عميقة). هذي الشبكات مستوحاة من طريقة عمل الخلايا العصبية بالدماغ البشري، وتقدر تتعلم أنماط معقدة جداً من كميات ضخمة من البيانات غير المنظمة، زي الصور، الصوت، والنصوص الطويلة.",
        "a2.p3b": "مثال عملي: التعرف على الوجوه في الصور، أو تحليل المشاعر في نص طويل مكتوب باللغة العربية، أو حتى المساعدات الصوتية الذكية. هذي المهام معقدة جداً بحيث يصعب على التعلم الآلي التقليدي التعامل معها بكفاءة، لكن التعلم العميق يتفوق فيها بشكل واضح.",
        "a2.h4": "متى تستخدم كل واحد؟",
        "a2.p4a": "القرار يعتمد على طبيعة مشكلتك وحجم بياناتك المتوفرة:",
        "a2.p4b": "استخدم التعلم الآلي التقليدي عندما يكون لديك بيانات منظمة (جداول)، حجم بيانات متوسط، وتحتاج نتائج سريعة وقابلة للتفسير بسهولة — مثل التنبؤ بالمبيعات أو تصنيف العملاء.",
        "a2.p4c": "استخدم التعلم العميق عندما تتعامل مع صور، صوت، أو نصوص طويلة، ولديك كمية كبيرة جداً من البيانات، وتقدر على استثمار وقت وموارد حوسبة أكبر للتدريب — مثل أنظمة التعرف على الصور أو معالجة اللغة الطبيعية المتقدمة.",
        "a2.h5": "الخلاصة",
        "a2.p5": "مو كل مشروع ذكاء اصطناعي يحتاج تعلم عميق، وأحياناً نموذج تعلم آلي بسيط يعطيك نتائج ممتازة بتكلفة وزمن أقل بكثير. الأهم هو اختيار الأداة المناسبة لحجم ونوع مشكلتك الفعلية، لا الأداة الأكثر تعقيداً أو الأحدث اسماً.",
    ...
    en: {
        ...
        "a2.p_intro": "One of the most common questions I get from clients: \"What's the difference between Machine Learning and Deep Learning? Why does everyone use them as if they're the same thing?\" The truth is there's an important difference between them, and understanding it helps you make a smarter decision when considering an AI project for your organization.",
        "a2.h1": "Artificial Intelligence: The Big Umbrella",
        "a2.p1": "Before distinguishing between them, we need to understand that \"Artificial Intelligence\" (AI) is the broadest term, referring to any system that mimics human capabilities like thinking, learning, and decision-making. Under this big umbrella falls \"Machine Learning,\" and under Machine Learning falls \"Deep Learning.\" In other words, every deep learning is machine learning, but not every machine learning is deep learning.",
        "a2.h2": "Machine Learning: The System Learns from Examples",
        "a2.p2a": "Machine learning is an approach that lets computers learn from data instead of us writing explicit instructions for every case. Instead of programming fixed rules, we give the system a large number of examples (like thousands of past financial transactions), and it learns the patterns and uses them to predict new cases. Practical example: a model that predicts a property's price based on area, location, and number of rooms, relying on data from thousands of previous properties.",
        "a2.p2b": "Machine learning works very well with structured data (like tables of numbers and categories), typically needs relatively less data compared to deep learning, and trains and runs faster.",
        "a2.h3": "Deep Learning: Networks That Mimic the Human Brain",
        "a2.p3a": "Deep learning is an advanced branch of machine learning, based on \"artificial neural networks\" made up of multiple layers (hence the word \"deep\" — meaning deep layers). These networks are inspired by how neurons work in the human brain, and can learn very complex patterns from massive amounts of unstructured data, like images, audio, and long texts.",
        "a2.p3b": "Practical example: facial recognition in images, sentiment analysis in a long Arabic text, or even smart voice assistants. These tasks are complex enough that traditional machine learning struggles to handle them efficiently, but deep learning clearly excels at them.",
        "a2.h4": "When Do You Use Each One?",
        "a2.p4a": "The decision depends on the nature of your problem and the size of your available data:",
        "a2.p4b": "Use traditional machine learning when you have structured data (tables), a medium data size, and need fast, easily interpretable results — such as sales forecasting or customer segmentation.",
        "a2.p4c": "Use deep learning when dealing with images, audio, or long texts, have a very large amount of data, and can invest more time and computing resources for training — such as image recognition systems or advanced natural language processing.",
        "a2.h5": "Conclusion",
        "a2.p5": "Not every AI project needs deep learning, and sometimes a simple machine learning model gives you excellent results at a much lower cost and time. What matters most is choosing the right tool for the actual size and type of your problem, not the most complex or newest-sounding tool.",
    ...
    fr: {
        ...
        "a2.p_intro": "Une des questions les plus fréquentes que je reçois de mes clients : \"Quelle est la différence entre l'apprentissage automatique (Machine Learning) et l'apprentissage profond (Deep Learning) ? Pourquoi tout le monde les utilise comme s'ils étaient identiques ?\" La vérité est qu'il existe une différence importante entre eux, et la comprendre vous aide à prendre une décision plus judicieuse lorsque vous envisagez un projet d'IA pour votre organisation.",
        "a2.h1": "L'Intelligence Artificielle : le grand parapluie",
        "a2.p1": "Avant de les distinguer, il faut comprendre que \"l'Intelligence Artificielle\" (IA) est le terme le plus large, désignant tout système qui imite les capacités humaines comme la réflexion, l'apprentissage et la prise de décision. Sous ce grand parapluie se trouve \"l'apprentissage automatique\", et sous l'apprentissage automatique se trouve \"l'apprentissage profond\". Autrement dit, tout apprentissage profond est de l'apprentissage automatique, mais tout apprentissage automatique n'est pas de l'apprentissage profond.",
        "a2.h2": "L'apprentissage automatique : le système apprend à partir d'exemples",
        "a2.p2a": "L'apprentissage automatique est une approche qui permet à l'ordinateur d'apprendre à partir de données au lieu que nous lui écrivions des instructions explicites pour chaque cas. Au lieu de programmer des règles fixes, nous donnons au système un grand nombre d'exemples (comme des milliers de transactions financières passées), et il apprend les schémas et les utilise pour prédire de nouveaux cas. Exemple pratique : un modèle qui prédit le prix d'un bien immobilier en fonction de la surface, de l'emplacement et du nombre de pièces, en s'appuyant sur les données de milliers de biens précédents.",
        "a2.p2b": "L'apprentissage automatique est très efficace avec les données structurées (comme les tableaux de chiffres et de catégories), nécessite généralement relativement moins de données par rapport à l'apprentissage profond, et s'entraîne et fonctionne plus rapidement.",
        "a2.h3": "L'apprentissage profond : des réseaux qui imitent le cerveau humain",
        "a2.p3a": "L'apprentissage profond est une branche avancée de l'apprentissage automatique, basée sur des \"réseaux de neurones artificiels\" composés de plusieurs couches (d'où le mot \"profond\" — c'est-à-dire des couches profondes). Ces réseaux s'inspirent du fonctionnement des neurones du cerveau humain, et peuvent apprendre des schémas très complexes à partir de grandes quantités de données non structurées, comme les images, l'audio et les longs textes.",
        "a2.p3b": "Exemple pratique : la reconnaissance faciale dans les images, l'analyse de sentiment dans un long texte arabe, ou même les assistants vocaux intelligents. Ces tâches sont suffisamment complexes pour que l'apprentissage automatique traditionnel ait du mal à les traiter efficacement, mais l'apprentissage profond excelle clairement dans ce domaine.",
        "a2.h4": "Quand utiliser chacun ?",
        "a2.p4a": "La décision dépend de la nature de votre problème et de la taille de vos données disponibles :",
        "a2.p4b": "Utilisez l'apprentissage automatique traditionnel lorsque vous avez des données structurées (tableaux), une taille de données moyenne, et que vous avez besoin de résultats rapides et facilement interprétables — comme la prévision des ventes ou la segmentation des clients.",
        "a2.p4c": "Utilisez l'apprentissage profond lorsque vous traitez des images, de l'audio ou de longs textes, que vous disposez d'une très grande quantité de données, et que vous pouvez investir plus de temps et de ressources de calcul pour l'entraînement — comme les systèmes de reconnaissance d'images ou le traitement avancé du langage naturel.",
        "a2.h5": "Conclusion",
        "a2.p5": "Tout projet d'IA n'a pas besoin d'apprentissage profond, et parfois un simple modèle d'apprentissage automatique vous donne d'excellents résultats à un coût et un temps bien moindres. Le plus important est de choisir le bon outil pour la taille et le type réels de votre problème, et non l'outil le plus complexe ou au nom le plus récent.",
